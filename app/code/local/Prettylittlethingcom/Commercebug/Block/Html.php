...
class Prettylittlethingcom_Commercebug_Block_Html extends Mage_Core_Block_Template
{	
    protected $_config;
    protected function _checkValidScriptPath($scriptPath)
    {
        $paths_to_check = array(Mage::getBaseDir('design'),Mage::getModuleDir('', 'Prettylittlethingcom_Commercebug'));
        $valid			= false;
    ...
    {	    	
        $module_dir = Mage::getModuleDir('', 'Prettylittlethingcom_Commercebug');
    ...
    protected function getConfig()
    {
        ...
        if($shim->isMage2())
        {
            #Prettylittlethingcom_Commercebug_Model_Shim::Log('Mage 2 Cleanup at: ' . __CLASS__ . ' ' . __LINE__);
