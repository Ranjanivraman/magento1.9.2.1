...
*/
class Prettylittlethingcom_Commercebug_Model_Shim
{
    ...
    */    
    ...
    protected function _getNamespaceForGroup($group)
    {
        ...
        {
            case 'commercebug':
                $module = 'Prettylittlethingcom_Commercebug';
    ...
    {
        $full_module_name = 'Prettylittlethingcom_Commercebug';
    ...
    static public function getInstance()
    {
        if(!self::$_instance)
        {
            self::$_instance = new Prettylittlethingcom_Commercebug_Model_Shim;
        }
