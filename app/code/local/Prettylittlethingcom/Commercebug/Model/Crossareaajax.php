...
*/
abstract class Prettylittlethingcom_Commercebug_Model_Crossareaajax
{
    ...
    */    
    ...
    {
        $controllers = array('Prettylittlethingcom_Commercebug_AjaxController','Prettylittlethingcom_Commercebug_AdminajaxController');
        ...
        foreach($controllers as $controller)
        {
            ...
            'Prettylittlethingcom_Commercebug_Model_Crossareaajax','appendAction'), self::$_actionNames);
