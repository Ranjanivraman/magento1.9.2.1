...
*/
class Prettylittlethingcom_Commercebug_Model_Collectorblocksandlayout extends Prettylittlethingcom_Commercebug_Model_Observingcollector
{
    ...
    {		
        ...
        foreach($this->_blocks as $block)
        {
            ...
            if(strpos($class,'Prettylittlethingcom_Commercebug') === 0)
            {
                continue;
            }
