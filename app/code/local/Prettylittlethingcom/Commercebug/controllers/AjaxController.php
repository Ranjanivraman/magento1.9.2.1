...
if(class_exists('Prettylittlethingcom_Commercebug_AjaxController', false)) { return; }

class Prettylittlethingcom_Commercebug_AjaxController extends Mage_Core_Controller_Front_Action
{   
